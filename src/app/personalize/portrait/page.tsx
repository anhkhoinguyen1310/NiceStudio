...
export default function PortraitPage() {
    return (
        <div className="container mx-auto px-4 py-20">
            <StickyDivider />
            <h1 className="text-4xl font-bold mb-8 text-black mt-8">Portrait</h1>
            <p className="mb-6 text-lg text-gray-700">
                Discover our portrait photography projects that highlight personality and style.
            </p>
            <section className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        { id: 1031, label: 'Studio Portrait' },
                        { id: 1032, label: 'Outdoor Portrait' },
                        { id: 1033, label: 'Creative Portrait' },
                    ].map(({ id, label }) => (
