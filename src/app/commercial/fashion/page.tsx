...
export default function CommercialPage() {
    return (
        <div className="container mx-auto px-4 py-20">
            <div className="border-t-4 border-black mt-4 sticky top-20 z-40"></div>
            <h1 className="text-4xl font-bold mb-8 text-black mt-8">Fashion</h1>
            <p className="mb-6 text-lg text-gray-700">
                Explore our fashion photography projects that showcase creativity and artistic expression.
            </p>
            {/* Add your fashion content here */}
